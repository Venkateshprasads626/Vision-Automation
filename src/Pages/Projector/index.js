    ...
    <div>
        <Header />
            <div className="Projector">
                ...
                <div className="Sony2">
                        <a href="https://pro.sony/en_BE/products/projectors" target="_blank"><img src={logo25} className="sonylogo" alt="SONY" /></a> 
                   </div>
                   <div className="epson2">
                        <a href="https://www.epson.co.in/homeprojector" target="_blank"><img src={logo13} className="epsonlogo" alt="EPSON" /></a> 
                   </div>
                   <div className="dell3">
                        <a href="https://www.dell.com/en-in/work/shop/projectors-and-projector-accessories/ar/5188" target="_blank"><img src={logo9} className="delllogo" alt="DELL" /></a> 
                    </div>
                    <div className="benq2">
